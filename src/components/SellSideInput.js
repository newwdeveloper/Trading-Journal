...
const SellSideInput = () => {
  return (
    <div className="w-full max-w-lg mx-auto p-4 bg-gray-100 shadow-lg rounded-xl">
      <div className="border-2 flex items-center justify-between gap-3 bg-red-500 p-3 rounded-xl">
        <label className="text-sm font-medium">SELL Date</label>
        <input
          className="bg-red-500 border-2 p-2 border-slate-600 rounded-xl w-2/3 text-sm"
          type="date"
          alt="date"
      ...
      <div className="flex flex-col gap-2 p-3 border-2 rounded-xl mt-3 bg-white">
        <label className="text-sm font-medium">Reason to Sell</label>
        <textarea
          className="border-2 p-2 rounded-xl w-full text-sm h-20 resize-none"
          placeholder="Explain why you are selling"
        ></textarea>
      </div>
